...
Logo=''' ___              _         _____     ____  _                _           ___  
|_ _|_ __ ___    / \   __ _| ____|   / ___|| |_ ___  __ _   / \   _ __  / _ \ 
 | || '_ ` _ \  / _ \ / _` |  _| ____\___ \| __/ _ \/ _` | / _ \ | '_ \| | | |
 | || | | | | |/ ___ \ (_| | |__|_____|__) | ||  __/ (_| |/ ___ \| | | | |_| |
|___|_| |_| |_/_/   \_\__, |_____|   |____/ \__\___|\__, /_/   \_\_| |_|\___/ 
                      |___/                         |___/                     
                                                                             '''                                                               			 
cprint(Logo, color="green")


if __name__ == "__main__":
    # print banner
    title = "^_^==|==|= ### Image Steganography Tool (by Blackwizard@jeo) ### ==|=|==^_^"
    cprint("*"*len(title), color="yellow")
    cprint("-"*len(title), color="green")
    print("")
    ...
    print("")
    #set up format
    cprint("CREATED BY BLACKWIZARD @ JEO", color="red")
    print("")
    # setup argument parser
    parser = argparse.ArgumentParser(description="A tool for image steganography based on password.")
